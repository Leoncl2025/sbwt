...
SEQAN_CHECKPOINT
        ...
        // bestimmen der hash bzw. shift-tabellen gr��e
...
SEQAN_CHECKPOINT
                ...
                //�berpr�fen, ob es noch weitere Funde an dieser Position gibt
                i = 0;
...
SEQAN_CHECKPOINT
            ...
            {
SEQAN_CHECKPOINT
                //�berpr�fen, ob es sich um einen Fund handelt
                h_hash = _compute_HASH_Hash(hash(me),infix(haystack_host,pos - window_width(me),pos),ndl_support,window_width(me));
                i = 0;
                h_length = length(me.HASH[h_hash]);
                while(i < h_length)
...
SEQAN_CHECKPOINT
                ...
                //Falls nichts an dieser Stelle gefunden wird, dann r�cke um 1 weiter
                ++finder;
                ++pos;
            }
            else
